...
Manage Trello boards, lists, and cards directly from AtomicBot.

## Setup

1. Get your API key: https://trello.com/app-key
2. Generate a token (click "Token" link on that page)
3. Configure via AtomicBot desktop app settings, or set environment variables:
   ```bash
   export TRELLO_API_KEY="your-api-key"
   export TRELLO_TOKEN="your-token"
   ```

The `TRELLO_API_KEY` and `TRELLO_TOKEN` environment variables are set automatically when configured through AtomicBot settings.
