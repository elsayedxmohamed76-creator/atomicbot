...
3. Configure via AtomicBot desktop app settings, or set the environment variable:
   ```bash
   export NOTION_API_KEY="ntn_your_key_here"
   ```
4. Share target pages/databases with your integration (click "..." → "Connect to" → your integration name)

The `NOTION_API_KEY` environment variable is set automatically when configured through AtomicBot settings.
