...
# Output:
# - dist/AtomicBot.app
# - dist/AtomicBot-<version>.zip
# - dist/AtomicBot-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.atomicbot.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/AtomicBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AtomicBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/AtomicBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AtomicBot-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AtomicBot-$VERSION.dSYM.zip"
