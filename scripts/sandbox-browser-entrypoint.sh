...
export DISPLAY=:1
export HOME=/tmp/atomicbot-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ATOMICBOT_BROWSER_CDP_PORT:-${ATOMICBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${ATOMICBOT_BROWSER_CDP_SOURCE_RANGE:-${ATOMICBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${ATOMICBOT_BROWSER_VNC_PORT:-${ATOMICBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ATOMICBOT_BROWSER_NOVNC_PORT:-${ATOMICBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ATOMICBOT_BROWSER_ENABLE_NOVNC:-${ATOMICBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ATOMICBOT_BROWSER_HEADLESS:-${ATOMICBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${ATOMICBOT_BROWSER_NO_SANDBOX:-${ATOMICBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${ATOMICBOT_BROWSER_NOVNC_PASSWORD:-${ATOMICBOT_BROWSER_NOVNC_PASSWORD:-}}"
