...
- Keep product names in English: AtomicBot, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AtomicBot Gateway, use “Gateway 网关”.
