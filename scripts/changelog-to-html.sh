...
if [[ -z "$version_content" ]]; then
  echo "<h2>AtomicBot $VERSION</h2>"
  echo "<p>Latest AtomicBot update.</p>"
  echo "<p><a href=\"https://github.com/atomicbot/atomicbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
