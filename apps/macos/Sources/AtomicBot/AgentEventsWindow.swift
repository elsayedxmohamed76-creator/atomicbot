...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: AtomicBotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": AtomicBotProtocol.AnyCodable("start"),
                "name": AtomicBotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
