...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AtomicBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AtomicBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AtomicBotConfigFile.loadDict()
            ...
            AtomicBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/atomicbot"
        state.remoteCliPath = ""
        return state
    }
}
