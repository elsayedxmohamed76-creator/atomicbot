...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/atomicbot/atomicbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/atomicbot/atomicbot")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AtomicBotBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AtomicBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AtomicBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AtomicBotGitCommit") as? String) ??
            "unknown"
    }
