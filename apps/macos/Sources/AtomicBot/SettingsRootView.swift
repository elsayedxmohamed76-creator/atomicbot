...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .atomicbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AtomicBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AtomicBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let atomicbotSelectSettingsTab = Notification.Name("atomicbotSelectSettingsTab")
}
