...
enum UIStrings {
    static let welcomeTitle = "Welcome to AtomicBot"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "atomicbot.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AtomicBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AtomicBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g atomicbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AtomicBotChatViewModel(
