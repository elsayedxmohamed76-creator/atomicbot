...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.atomicbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".atomicbot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.atomicbotCommand(
            subcommand: "gateway",
