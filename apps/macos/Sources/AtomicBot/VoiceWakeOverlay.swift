...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.atomicbot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AtomicBot windows, but below the system’s pop-up menus.
