...
export function RestoreOptionPage(props: { totalSteps: number; activeStep: number }) {
  ...
  const handleContinue = React.useCallback(async () => {
    ...
    // "local" option: auto-detect ~/.atomicbot, then restore or open folder picker
    ...
    try {
      ...
      if (!folderResult.ok || !folderResult.path) {
        throw new Error(
          folderResult.error || "Selected folder does not contain a valid AtomicBot configuration."
        );
      }
        ...
        <div className="UiProviderList UiListWithScroll scrollable">
          ...
          >
            ...
            <div className={s.UiRestoreOptionText}>
              <div className={s.UiRestoreOptionName}>Restore from local AtomicBot instance</div>
              <div className={s.UiRestoreOptionDesc}>
                Automatically detect and import an AtomicBot instance on this device.
              </div>
            </div>
          </label>
          ...
          >
            ...
            <div className={s.UiRestoreOptionText}>
              ...
              <div className={s.UiRestoreOptionDesc}>
                Upload a backup file to restore your AtomicBot configuration.
              </div>
            </div>
          </label>
        </div>
