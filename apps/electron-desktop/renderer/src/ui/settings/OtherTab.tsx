    ...
    <div className={ps.UiSettingsContentInner}>
      ...
      <section className={s.UiSettingsOtherSection}>
        ...
        <p className={s.UiSettingsOtherHint}>
          Create a full backup of your AtomicBot configuration or restore from a previously saved
          backup.
        </p>
      </section>
      ...
      {/* Folders: AtomicBot data + Agent workspace */}
      <section className={s.UiSettingsOtherSection}>
        <h3 className={s.UiSettingsOtherSectionTitle}>Folders</h3>
        <div className={s.UiSettingsOtherCard}>
          <div className={s.UiSettingsOtherRow}>
            <span className={s.UiSettingsOtherRowLabel}>AtomicBot folder</span>
            <button
              type="button"
              className={s.UiSettingsOtherLink}
        ...
        <p className={s.UiSettingsOtherHint}>
          Contains your local AtomicBot state and app data. Workspace contains editable .md files
      ...
      <section className={s.UiSettingsOtherSection}>
        ...
        <p className={s.UiSettingsOtherHint}>
          Built-in terminal with atomicbot and bundled tools in PATH.
        </p>
      </section>
