## AtomicBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_atomicbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm atomicbot gateway --port 18789 --verbose
```
