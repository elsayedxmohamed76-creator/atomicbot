...
public enum AtomicBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct AtomicBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AtomicBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
