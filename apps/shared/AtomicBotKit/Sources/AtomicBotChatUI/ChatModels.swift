...
public typealias AtomicBotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AtomicBotPlatformImage = UIImage
#endif

public struct AtomicBotChatUsageCost: Codable, Hashable, Sendable {
...
public struct AtomicBotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AtomicBotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AtomicBotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AtomicBotChatMessageContent: Codable, Hashable, Sendable {
...
public struct AtomicBotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AtomicBotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AtomicBotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AtomicBotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AtomicBotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AtomicBotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AtomicBotChatMessageContent].self, forKey: .content) {
...
public struct AtomicBotChatHistoryPayload: Codable, Sendable {
...
public struct AtomicBotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AtomicBotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AtomicBotSessionPreviewItem]
}

public struct AtomicBotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AtomicBotSessionPreviewEntry]

    public init(ts: Int, previews: [AtomicBotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AtomicBotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AtomicBotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AtomicBotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AtomicBotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AtomicBotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AtomicBotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AtomicBotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: AtomicBotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct AtomicBotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
