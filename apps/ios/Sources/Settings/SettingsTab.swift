...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AtomicBotLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AtomicBotLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.atomicbot.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected AtomicBot agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips while AtomicBot is foregrounded.")
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for AtomicBot. Off disables location tools, While Using enables foreground location, and Always enables background location.")
                            } label: {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AtomicBotLocationMode.off.rawValue)
                            Text("While Using").tag(AtomicBotLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AtomicBotLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while AtomicBot is open.")
                            ...
                            HStack(spacing: 8) {
                                ...
                                Button {
                                    self.activeFeatureHelp = FeatureHelp(
                                        ...
                                        message: "Appends this instruction when sharing content into AtomicBot from iOS.")
                                } label: {
                                    Image(systemName: "info.circle")
                                        .foregroundStyle(.secondary)
                                }
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("AtomicBot", value: self.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AtomicBotLocationMode(rawValue: newValue) else { return }
                Task {
