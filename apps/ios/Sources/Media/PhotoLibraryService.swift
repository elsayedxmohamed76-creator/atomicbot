...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AtomicBotPhotosLatestParams) async throws -> AtomicBotPhotosLatestPayload {
        ...
        var results: [AtomicBotPhotoPayload] = []
        ...
        return AtomicBotPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AtomicBotPhotoPayload
    {
