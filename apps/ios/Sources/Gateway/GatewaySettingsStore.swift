...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.atomicbot.gateway"
    private static let nodeService = "ai.atomicbot.node"
    private static let talkService = "ai.atomicbot.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.atomicbot.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.atomicbot.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("atomicbot-gateway.log")
    }
