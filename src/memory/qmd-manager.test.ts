...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: AtomicBotConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: AtomicBotConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__atomicbotMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__atomicbotMcporterColdStartWarned;
  });
