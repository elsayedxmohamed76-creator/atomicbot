...
export function listChannelMessageActions(cfg: AtomicBotConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AtomicBotConfig): boolean {
...
export function supportsChannelMessageCards(cfg: AtomicBotConfig): boolean {
