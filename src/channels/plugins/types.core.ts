...
export type ChannelAgentToolFactory = (params: { cfg?: AtomicBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AtomicBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AtomicBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AtomicBotConfig }) => boolean;
  supportsCards?: (params: { cfg: AtomicBotConfig }) => boolean;
