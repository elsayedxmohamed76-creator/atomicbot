...
export function listWhatsAppAuthDirs(cfg: AtomicBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AtomicBotConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AtomicBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AtomicBotConfig): ResolvedWhatsAppAccount[] {
