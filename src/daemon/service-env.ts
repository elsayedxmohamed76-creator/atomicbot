...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.ATOMICBOT_STATE_DIR;
  const configPath = env.ATOMICBOT_CONFIG_PATH;
  ...
  return {
    ...
    ATOMICBOT_PROFILE: profile,
    ATOMICBOT_STATE_DIR: stateDir,
    ATOMICBOT_CONFIG_PATH: configPath,
    ATOMICBOT_GATEWAY_PORT: String(port),
    ATOMICBOT_GATEWAY_TOKEN: token,
    ATOMICBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ATOMICBOT_SYSTEMD_UNIT: systemdUnit,
    ATOMICBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ATOMICBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ATOMICBOT_STATE_DIR: stateDir,
    ATOMICBOT_CONFIG_PATH: configPath,
    ATOMICBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ATOMICBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ATOMICBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ATOMICBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ATOMICBOT_LOG_PREFIX: "node",
    ATOMICBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ATOMICBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    ATOMICBOT_SERVICE_VERSION: VERSION,
  };
}
