...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.atomicbot.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ATOMICBOT_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.atomicbot.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.atomicbot.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ATOMICBOT_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.atomicbot.gateway.plist",
    },
    {
      name: "uses profile-specific label when ATOMICBOT_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ATOMICBOT_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.atomicbot.jbphoenix.plist",
    },
    {
      name: "prefers ATOMICBOT_LAUNCHD_LABEL over ATOMICBOT_PROFILE",
      env: {
        HOME: "/Users/test",
        ATOMICBOT_PROFILE: "jbphoenix",
        ATOMICBOT_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ATOMICBOT_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ATOMICBOT_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ATOMICBOT_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ATOMICBOT_PROFILE: "myprofile",
        ATOMICBOT_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.atomicbot.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
