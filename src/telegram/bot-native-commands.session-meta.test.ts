...
function registerAndResolveStatusHandler(cfg: AtomicBotConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/atomicbot-sessions.json");
