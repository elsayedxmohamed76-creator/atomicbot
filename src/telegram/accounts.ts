...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ATOMICBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AtomicBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AtomicBotConfig): string {
...
function mergeTelegramAccountConfig(cfg: AtomicBotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AtomicBotConfig): ResolvedTelegramAccount[] {
