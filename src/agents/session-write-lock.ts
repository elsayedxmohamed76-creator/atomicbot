...
const CLEANUP_STATE_KEY = Symbol.for("atomicbot.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("atomicbot.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("atomicbot.sessionWriteLockWatchdogState");
