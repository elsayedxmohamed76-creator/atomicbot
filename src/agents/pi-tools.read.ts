...
function resolveAdaptiveReadMaxBytes(options?: AtomicBotReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAtomicBotReadTool(base, {
...
export function createAtomicBotReadTool(
  base: AnyAgentTool,
  options?: AtomicBotReadToolOptions,
): AnyAgentTool {
