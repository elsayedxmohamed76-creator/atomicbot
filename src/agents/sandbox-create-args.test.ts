...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "atomicbot-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "atomicbot.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "atomicbot.sandbox=1",
        "--label",
        "atomicbot.sessionKey=main",
        "--label",
        "atomicbot.createdAtMs=1700000000000",
        "--label",
