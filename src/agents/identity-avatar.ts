...
function resolveAvatarSource(cfg: AtomicBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AtomicBotConfig, agentId: string): AgentAvatarResolution {
