...
async function resolveContext(config: AtomicBotConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AtomicBotConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
