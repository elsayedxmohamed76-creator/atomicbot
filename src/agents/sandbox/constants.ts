...
export const DEFAULT_SANDBOX_IMAGE = "atomicbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "atomicbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "atomicbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "atomicbot-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "atomicbot-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "atomicbot-sandbox-browser";
