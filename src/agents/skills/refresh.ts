...
function resolveWatchPaths(workspaceDir: string, config?: AtomicBotConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AtomicBotConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AtomicBotConfig }) {
