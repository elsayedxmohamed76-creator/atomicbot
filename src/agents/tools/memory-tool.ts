...
function resolveMemoryToolContext(options: { config?: AtomicBotConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: AtomicBotConfig): MemoryCitationsMode {
