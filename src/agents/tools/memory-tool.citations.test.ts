...
function asAtomicBotConfig(config: Partial<AtomicBotConfig>): AtomicBotConfig {
  return config as AtomicBotConfig;
}

function createToolConfig() {
  return asAtomicBotConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: AtomicBotConfig = createToolConfig()) {
