...
const defaultTools = createAtomicBotCodingTools({ senderIsOwner: true });
...
describe("createAtomicBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAtomicBotCodingTools({
      config,
    ...
    const anthropicTools = createAtomicBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAtomicBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAtomicBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
