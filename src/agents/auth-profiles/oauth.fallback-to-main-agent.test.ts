...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAtomicBotAgentDir() returns mainAgentDir
    process.env.ATOMICBOT_STATE_DIR = tmpDir;
    process.env.ATOMICBOT_AGENT_DIR = mainAgentDir;
