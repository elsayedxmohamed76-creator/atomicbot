...
/**
 * Convert an AtomicBot auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * AtomicBot stores credentials in auth-profiles.json instead. This helper
