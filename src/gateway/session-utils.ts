...
import { type AtomicBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AtomicBotConfig): string[] {
...
export function listAgentsForGateway(cfg: AtomicBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AtomicBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: AtomicBotConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AtomicBotConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AtomicBotConfig): GatewaySessionsDefaults {
