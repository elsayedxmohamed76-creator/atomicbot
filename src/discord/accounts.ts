...
function mergeDiscordAccountConfig(cfg: AtomicBotConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: AtomicBotConfig): ResolvedDiscordAccount[] {
