...
export const A2UI_PATH = "/__atomicbot__/a2ui";

export const CANVAS_HOST_PATH = "/__atomicbot__/canvas";

export const CANVAS_WS_PATH = "/__atomicbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.atomicbotCanvasA2UIAction.postMessage(...)
  // - Android: window.atomicbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["atomicbotCanvasA2UIAction"];
  ...
  globalThis.AtomicBot = globalThis.AtomicBot ?? {};
  globalThis.AtomicBot.postMessage = postToNode;
  globalThis.AtomicBot.sendUserAction = sendUserAction;
  globalThis.atomicbotPostMessage = postToNode;
  globalThis.atomicbotSendUserAction = sendUserAction;
