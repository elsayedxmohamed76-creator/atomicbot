...
export function applyOpenrouterProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyMoonshotConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AtomicBotConfig): AtomicBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AtomicBotConfig): AtomicBotConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AtomicBotConfig): AtomicBotConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyQianfanProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AtomicBotConfig): AtomicBotConfig {
