...
function resolveDefaultAccountId(cfg: AtomicBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AtomicBotConfig): boolean {
...
export function summarizeBindings(cfg: AtomicBotConfig, bindings: AgentBinding[]): string[] {
