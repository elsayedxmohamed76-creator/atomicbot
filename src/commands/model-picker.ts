...
type PromptDefaultModelResult = { model?: string; config?: AtomicBotConfig };
...
function resolveConfiguredModelRaw(cfg: AtomicBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: AtomicBotConfig): string[] {
...
export function applyPrimaryModel(cfg: AtomicBotConfig, model: string): AtomicBotConfig {
...
export function applyModelAllowlist(cfg: AtomicBotConfig, models: string[]): AtomicBotConfig {
  const defaults = cfg.agents?.defaults;
