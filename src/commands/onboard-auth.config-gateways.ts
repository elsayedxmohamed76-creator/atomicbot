...
export function applyVercelAiGatewayProviderConfig(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyVercelAiGatewayConfig(cfg: AtomicBotConfig): AtomicBotConfig {
