...
function mergeIMessageAccountConfig(cfg: AtomicBotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AtomicBotConfig): ResolvedIMessageAccount[] {
