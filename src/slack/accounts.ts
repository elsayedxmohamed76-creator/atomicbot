...
function mergeSlackAccountConfig(cfg: AtomicBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AtomicBotConfig): ResolvedSlackAccount[] {
