...
// Prefix for AtomicBot-generated action IDs to scope our handler
const ATOMICBOT_ACTION_PREFIX = "atomicbot:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${ATOMICBOT_ACTION_PREFIX}`);

  // Handle AtomicBot modal submissions with callback_ids scoped by our prefix.
