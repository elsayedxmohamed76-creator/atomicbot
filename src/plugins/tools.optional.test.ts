...
const loadAtomicBotPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadAtomicBotPlugins: (params: unknown) => loadAtomicBotPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadAtomicBotPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadAtomicBotPluginsMock.mockClear();
  });
