...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @atomicbot/voice-call -> voice-call).
...
export function discoverAtomicBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".atomicbot", "extensions")];
