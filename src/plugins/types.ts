...
export type AtomicBotPluginConfigSchema = {
...
export type AtomicBotPluginToolContext = {
...
export type AtomicBotPluginToolFactory = (
  ctx: AtomicBotPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type AtomicBotPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type AtomicBotPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<AtomicBotConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type AtomicBotPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current AtomicBot configuration */
  config: AtomicBotConfig;
 ...
 */
export type AtomicBotPluginCommandDefinition = {
...
export type AtomicBotPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type AtomicBotPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type AtomicBotPluginCliContext = {
  program: Command;
  config: AtomicBotConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type AtomicBotPluginCliRegistrar = (ctx: AtomicBotPluginCliContext) => void | Promise<void>;

export type AtomicBotPluginServiceContext = {
  config: AtomicBotConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type AtomicBotPluginService = {
  id: string;
  start: (ctx: AtomicBotPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: AtomicBotPluginServiceContext) => void | Promise<void>;
};

export type AtomicBotPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type AtomicBotPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: AtomicBotPluginConfigSchema;
  register?: (api: AtomicBotPluginApi) => void | Promise<void>;
  activate?: (api: AtomicBotPluginApi) => void | Promise<void>;
};

export type AtomicBotPluginModule =
  | AtomicBotPluginDefinition
  | ((api: AtomicBotPluginApi) => void | Promise<void>);

export type AtomicBotPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | AtomicBotPluginToolFactory,
    opts?: AtomicBotPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: AtomicBotPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: AtomicBotPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: AtomicBotPluginHttpRouteHandler }) => void;
  registerChannel: (registration: AtomicBotPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: AtomicBotPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: AtomicBotPluginService) => void;
   ...
   */
  registerCommand: (command: AtomicBotPluginCommandDefinition) => void;
