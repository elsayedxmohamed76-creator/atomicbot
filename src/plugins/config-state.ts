...
export const normalizePluginsConfig = (
  config?: AtomicBotConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: AtomicBotConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: AtomicBotConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: AtomicBotConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
