...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/atomicbot/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/atomicbot/extensions",
        global: "/Users/x/.atomicbot/extensions",
        workspace: "/Users/x/ws/.atomicbot/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.atomicbot/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/atomicbot/extensions",
        global: "/Users/x/.atomicbot/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.atomicbot/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/atomicbot/extensions",
        global: "/Users/x/.atomicbot/extensions",
