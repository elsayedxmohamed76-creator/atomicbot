...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/atomicbot/atomicbot/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ATOMICBOT_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.atomicbot/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AtomicBotConfig = {
    ...params.cfg,
