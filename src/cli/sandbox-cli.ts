...
const SANDBOX_EXAMPLES = {
  main: [
    ["atomicbot sandbox list", "List all sandbox containers."],
    ["atomicbot sandbox list --browser", "List only browser containers."],
    ["atomicbot sandbox recreate --all", "Recreate all containers."],
    ["atomicbot sandbox recreate --session main", "Recreate a specific session."],
    ["atomicbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["atomicbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["atomicbot sandbox list", "List all sandbox containers."],
    ["atomicbot sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["atomicbot sandbox recreate --all", "Recreate all containers."],
    ["atomicbot sandbox recreate --session main", "Recreate a specific session."],
    ["atomicbot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["atomicbot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["atomicbot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["atomicbot sandbox explain", "Show effective sandbox config."],
    ["atomicbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["atomicbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["atomicbot sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.atomicbot.ai/cli/sandbox")}\n`,
    )
    .action(() => {
