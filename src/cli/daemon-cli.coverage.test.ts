...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ATOMICBOT_STATE_DIR = "/tmp/atomicbot-cli-state";
    process.env.ATOMICBOT_CONFIG_PATH = "/tmp/atomicbot-cli-state/atomicbot.json";
    delete process.env.ATOMICBOT_GATEWAY_PORT;
    delete process.env.ATOMICBOT_PROFILE;
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        ATOMICBOT_STATE_DIR: "/tmp/atomicbot-daemon-state",
        ATOMICBOT_CONFIG_PATH: "/tmp/atomicbot-daemon-state/atomicbot.json",
        ATOMICBOT_GATEWAY_PORT: "19001",
      },
