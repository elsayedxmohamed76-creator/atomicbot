    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["atomicbot directory self --channel slack", "Show the connected account identity."],
          [
            'atomicbot directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["atomicbot directory groups list --channel discord", "List available groups/channels."],
          [
            "atomicbot directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.atomicbot.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
