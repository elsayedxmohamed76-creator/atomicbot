    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["atomicbot channels list", "List configured channels and auth profiles."],
          ["atomicbot channels status --probe", "Run channel status checks and probes."],
          [
            "atomicbot channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["atomicbot channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.atomicbot.ai/cli/channels",
        )}\n`,
    );
