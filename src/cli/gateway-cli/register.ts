      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["atomicbot gateway run", "Run the gateway in the foreground."],
            ["atomicbot gateway status", "Show service status and probe reachability."],
            ["atomicbot gateway discover", "Find local and wide-area gateway beacons."],
            ["atomicbot gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.atomicbot.ai/cli/gateway")}\n`,
      ),
  );
