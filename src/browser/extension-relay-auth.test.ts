...
import {
  probeAuthenticatedAtomicBotRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated atomicbot relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedAtomicBotRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-atomicbot-relay-token",
