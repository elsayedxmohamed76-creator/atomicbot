...
function mergeSignalAccountConfig(cfg: AtomicBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AtomicBotConfig): ResolvedSignalAccount[] {
