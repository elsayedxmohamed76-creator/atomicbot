...
function resolveAnthropicDefaultAuthMode(cfg: AtomicBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyTalkApiKey(config: AtomicBotConfig): AtomicBotConfig {
...
export function applyModelDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyLoggingDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyContextPruningDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
...
export function applyCompactionDefaults(cfg: AtomicBotConfig): AtomicBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
