...
export type { AtomicBotConfig } from "../config/config.js";
/** @deprecated Use AtomicBotConfig instead */
export type { AtomicBotConfig as AtomicbotConfig } from "../config/config.js";
