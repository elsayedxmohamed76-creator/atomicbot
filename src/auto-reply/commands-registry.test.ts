...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@atomicbot", { botUsername: "atomicbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@atomicbot args", {
        botUsername: "atomicbot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@atomicbot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "atomicbot" })).toBe(
      "/help@otherbot",
    );
  });
