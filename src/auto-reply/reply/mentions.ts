...
function resolveMentionPatterns(cfg: AtomicBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AtomicBotConfig | undefined, agentId?: string): RegExp[] {
