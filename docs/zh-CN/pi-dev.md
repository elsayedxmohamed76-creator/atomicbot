...
本指南总结了在 AtomicBot 中开发 Pi 集成的合理工作流程。
...
状态存储在 AtomicBot 状态目录下。默认为 `~/.atomicbot`。如果设置了 `ATOMICBOT_STATE_DIR`，则使用该目录。
...
- https://docs.atomicbot.ai/testing
- https://docs.atomicbot.ai/start/getting-started
