...
- 生成的 Swift 模型：`apps/macos/Sources/AtomicBotProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/atomicbot/atomicbot/main/dist/protocol.schema.json
