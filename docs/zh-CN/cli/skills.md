...
summary: "`atomicbot skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
atomicbot skills list
atomicbot skills list --eligible
atomicbot skills info <name>
atomicbot skills check
```
