...
- Install via CLI: `atomicbot plugins install @atomicbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `atomicbot plugins install ./extensions/zalo`
   - From npm (if published): `atomicbot plugins install @atomicbot/zalo`
...
- Approve via:
  - `atomicbot pairing list zalo`
  - `atomicbot pairing approve zalo <CODE>`
...
- Example: `atomicbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `atomicbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `atomicbot logs --follow`
