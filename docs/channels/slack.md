...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure AtomicBot HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `atomicbot pairing approve slack <code>`.
...
AtomicBot supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, AtomicBot falls back to normal delivery for remaining payloads.
