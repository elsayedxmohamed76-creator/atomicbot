---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AtomicBot"
read_when:
  - You want Xiaomi MiMo models in AtomicBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AtomicBot uses
