---
summary: "Use Qianfan's unified API to access many models in AtomicBot"
read_when:
...
3. AtomicBot installed on your system
...
4. Copy the API key for use with AtomicBot

## CLI setup

```bash
atomicbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AtomicBot Configuration](/gateway/configuration)
