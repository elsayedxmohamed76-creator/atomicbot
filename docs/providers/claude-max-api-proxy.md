...
You can point AtomicBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AtomicBot
...
- [Anthropic provider](/providers/anthropic) - Native AtomicBot integration with Claude setup-token or API keys
