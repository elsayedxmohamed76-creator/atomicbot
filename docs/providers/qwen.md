---
summary: "Use Qwen OAuth (free tier) in AtomicBot"
read_when:
  - You want to use Qwen with AtomicBot
...
If you already logged in with the Qwen Code CLI, AtomicBot will sync credentials
