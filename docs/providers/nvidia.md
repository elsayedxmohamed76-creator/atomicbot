---
summary: "Use NVIDIA's OpenAI-compatible API in AtomicBot"
read_when:
  - You want to use NVIDIA models in AtomicBot
...
atomicbot onboard --auth-choice skip
atomicbot models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
