...
Deploy AtomicBot on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/atomicbot-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
- `https://<your-railway-domain>/atomicbot` — Control UI

## What you get

- Hosted AtomicBot Gateway + Control UI
...
- `ATOMICBOT_STATE_DIR=/data/.atomicbot` (recommended)
- `ATOMICBOT_WORKSPACE_DIR=/data/workspace` (recommended)
- `ATOMICBOT_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your AtomicBot state + workspace so you can migrate to another host without losing config or memory.
