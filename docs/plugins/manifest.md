...
read_when:
  - You are building a AtomicBot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (atomicbot.plugin.json)

Every plugin **must** ship a `atomicbot.plugin.json` file in the **plugin root**.
AtomicBot uses this manifest to validate configuration **without executing plugin
