...
read_when:
  ...
  - Wiring external systems into AtomicBot
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your AtomicBot config directory (typically `~/.atomicbot/hooks/transforms`).
...
- `atomicbot webhooks gmail setup` writes `hooks.gmail` config for `atomicbot webhooks gmail run`.
