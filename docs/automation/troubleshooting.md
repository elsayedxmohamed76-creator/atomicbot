...
atomicbot system heartbeat last
atomicbot logs --follow
atomicbot config get agents.defaults.heartbeat
atomicbot channels status --probe
```
...
```bash
atomicbot config get agents.defaults.heartbeat.activeHours
atomicbot config get agents.defaults.heartbeat.activeHours.timezone
atomicbot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
atomicbot cron list
atomicbot logs --follow
```
