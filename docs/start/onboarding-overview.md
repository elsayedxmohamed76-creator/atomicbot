---
summary: "Overview of AtomicBot onboarding options and flows"
read_when:
...
AtomicBot supports multiple onboarding paths depending on where the Gateway runs
...
- [`atomicbot onboard` command](/cli/onboard)

## macOS app onboarding

Use the AtomicBot app when you want a fully guided setup on macOS. Docs:
