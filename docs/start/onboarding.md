---
summary: "First-run onboarding flow for AtomicBot (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AtomicBot">
...
<Step title="CLI">
  ...
  The app can install the global `atomicbot` CLI via npm/pnpm so terminal
