import type { ChannelOnboardingAdapter, AtomicBotConfig, WizardPrompter } from "atomicbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.atomicbot.ai/channels/mattermost",
    ].join("\n"),
