...
export function listMattermostAccountIds(cfg: AtomicBotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AtomicBotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AtomicBotConfig): ResolvedMattermostAccount[] {
