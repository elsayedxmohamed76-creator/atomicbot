...
import { resolveChannelMediaMaxBytes, type AtomicBotConfig } from "atomicbot/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AtomicBotConfig; accountId?: string }): string[] {
