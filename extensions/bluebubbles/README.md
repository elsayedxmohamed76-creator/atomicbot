...
This directory contains the **BlueBubbles external channel plugin** for AtomicBot.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `atomicbot/plugin-sdk` helpers.
