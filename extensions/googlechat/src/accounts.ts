...
export function listGoogleChatAccountIds(cfg: AtomicBotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AtomicBotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AtomicBotConfig): ResolvedGoogleChatAccount[] {
