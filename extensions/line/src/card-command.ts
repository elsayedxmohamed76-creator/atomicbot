import type { LineChannelData, AtomicBotPluginApi, ReplyPayload } from "atomicbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: AtomicBotPluginApi): void {
  api.registerCommand({
    name: "card",
