...
Nostr DM channel plugin for AtomicBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AtomicBot. It enables your bot to:
...
# Configure atomicbot to use local relay
