...
export function listZalouserAccountIds(cfg: AtomicBotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AtomicBotConfig): string {
...
function mergeZalouserAccountConfig(cfg: AtomicBotConfig, accountId: string): ZalouserAccountConfig {
