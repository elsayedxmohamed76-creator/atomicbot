import type { AtomicbotConfig, PluginRuntime, RuntimeEnv } from "atomicbot/plugin-sdk";
...
async function dispatchMessage(params: { cfg: AtomicbotConfig; event: FeishuMessageEvent }) {
