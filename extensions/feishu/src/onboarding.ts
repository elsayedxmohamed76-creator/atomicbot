...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "atomicbot/plugin-sdk";
...
function setFeishuDmPolicy(cfg: AtomicbotConfig, dmPolicy: DmPolicy): AtomicbotConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: AtomicbotConfig, allowFrom: string[]): AtomicbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: AtomicbotConfig, groupAllowFrom: string[]): AtomicbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
