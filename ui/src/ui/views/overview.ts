...
export function renderOverview(props: OverviewProps) {
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <span class="mono">atomicbot devices list</span><br />
          <span class="mono">atomicbot devices approve &lt;requestId&gt;</span>
        </div>
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.atomicbot.ai/web/control-ui#device-pairing-first-connection"
            target="_blank"
            rel="noreferrer"
  ...
  const authHint = (() => {
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">atomicbot dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">atomicbot doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.atomicbot.ai/web/dashboard"
              target="_blank"
              rel="noreferrer"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "atomicbot dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.atomicbot.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.atomicbot.ai/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.atomicbot.ai/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="ATOMICBOT_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
